...
def train_model(X, y, class_labels, test_size=0.2, use_bayesian=False):
    """
    Modified version with better split (80/20 instead of 70/30) and split summary
    """
    # Using 80/20 split for better training data utilization
    ...
    xgb = XGBClassifier(
        ...
        scale_pos_weight=scale_pos_weight,  # This handles the imbalance!
        random_state=42,
    )
...
def plot_confusion_matrix(
    ...
    ConfusionMatrixDisplay.from_estimator(
        model, X_test_selected, y_test, display_labels=class_labels, cmap="Blues"
    )
...
if __name__ == "__main__":
    ...
    # Now passing class_labels to train_model for the split summary
    model_info = train_model(X, y, class_labels, test_size=0.2, use_bayesian=False)
